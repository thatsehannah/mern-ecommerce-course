    ...
    <Router>
      ...
      <main className='py-3'>
        <Container>
          ...
          <Route path='/admin/productlist/:p' component={AdminProductListScreen} exact/>
          ...
          {/* Search Box ^^^^^^ */}
          <Route path='/page/:p' component={HomeScreen} exact/>
          <Route path='/search/:keyword/page/:p' component={HomeScreen} exact />
